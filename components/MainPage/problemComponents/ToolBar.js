...
function ToolBar(props) {
  ...
  return (
    <div className="flex justify-between z-[1000] bg-white/90 shadow-xl sticky top-0 rounded-xl border-b-2 border-t-0 items-center ">
      ...
      {ideaBar ? ( <div className="whitespace-nowrap flex w-[30em] ml-4"><p className="text-t-bl">Current Idea: </p><p className="text-t-pd ml-2 truncate">{ideaBar}</p></div>) : <div></div>}
