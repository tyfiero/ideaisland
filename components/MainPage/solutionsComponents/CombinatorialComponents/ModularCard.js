...
function ModularCard({
  ...
  useEffect(() => {
    ...
    if (type === "Intro") {
      ...
      if (typeChanged) {
        let newArray = sArray;
        newArray[card] = { id: id, type: type, list: introOptions[1].label, text: "How might we" };
    dispatch(sArrayAction(newArray));
      ...
      //  console.log(newArray[card])
        ...
        newArray[card] = { id: id, type: type, list: nounOptions[0].label, text: "noun" };
      //  console.log(newArray[card])
    ...
    setContent("noun");
      ...
      if (typeChanged) {
        let newArray = sArray;
        newArray[card] = { id: id, type: type, list: verbOptions[1].label, text: "verb" };
    dispatch(sArrayAction(newArray));
    console.log(sArray)
        setContent("verb");
      ...
      if (typeChanged) {
        let newArray = sArray;
        newArray[card] = { id: id, type: type, list: outcomeOptions[1].label, text: "for entrepreneurs?" };
    dispatch(sArrayAction(newArray));
