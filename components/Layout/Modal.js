...
const Modal = ({ setOpenShareMenu }) => {
    ...
    let description ="An app that helps you find the best ideas for your next project"
    ...
    return (
      <>
        ...
        <div className="centered">
          <div className={"modal glass-box shadow-2xl flex flex-col  items-center"}>
            ...
            <EmailShareButton  subject={"Check out this app"} body={"I think you would like it!"} url={link} separator="  ">
                <EmailIcon size={40} round />
            </EmailShareButton>

            <TwitterShareButton  url={link} title={"Check out this app I found, it helps you find the best ideas for your next project"}  via="TheIdeaIsland" hashtags={["ideas","innovation", "softwaredevelopment"]}>
   ...
   <PinterestShareButton media={imageUrl} url={link} description={description}>
