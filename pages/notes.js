        ...
        {isMobile ? (
          <div className="w-full">
            {openNote && (
              <div className="">
                <button
                  className="flex items-center gap-2 px-3 py-1 my-1 ml-3 text-sm transition rounded-xl nun bg-clear-pl4 hover:scale-105 active:scale-95"
                  onClick={() => {
            ...
            {openNote ? (
              <div className="w-full">
                ...
                {currentNote === "problem" && (
                  <ProblemEditor type={currentNote} />
                )}
              </div>
            ) : (
              <div className="normal-box-soft h-full !rounded-2xl  min-w-[240px] fade-effect-quick">
                <IdeaSideBar
                  type={currentNote}
